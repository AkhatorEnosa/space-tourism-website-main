...
function contentSelect(e) {
  if(e.target.matches("div.destination-link") && !e.target.classList.contains("active")){
    ...
    if(e.target.matches("div.mars")) { //check if mars link has been clicked
      spaceElement.src = "../code/assets/destination/image-mars.webp";
      ...
      spaceElement.src = "../code/assets/destination/image-europa.webp";
      ...
      spaceElement.src = "../code/assets/destination/image-titan.webp";
      ...
      spaceElement.src = "../code/assets/destination/image-moon.webp";
